...
var render_timeseries = {
  type: "cccLineChart",
  name: "render_timeseries",
  priority: 5,
  parameters: [],
  executeAtStart: true,
  htmlObject: "${h:timeseries}",
  preExecution: function() {
    var cd = this.chartDefinition;
    
    var cdProps = {
        // Main plot
        title: this.dashboard.i18nSupport.prop('BOTTOMCHART.TITLE'),
        baseAxisTickFormatter: function(label) {
  ...
  chartDefinition:  {
    ...
    path: "/public/Ctools Book Samples/Chapter 8/Internacionalization/internacionalization.cda",
    height: 200,
    extensionPoints: [],
    colors: [],
    animate: true,
